...
In the case that there is no matching CMIP6 variable for the proposed dataset or doubt about it, please contact the CMUG support. Such data can be considered for obs4MIPs but require the additional steps:
